<div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="carousel" style="height: 560px;">
  ...
  <div class="carousel-inner">
    <#if Fieldset61255941.getSiblings()?has_content>
      <#list Fieldset61255941.getSiblings() as cur_Fieldset61255941>
        <div class="carousel-item<#if cur_Fieldset61255941?index == 0> active</#if>" style="height: 560px;">
          <#if cur_Fieldset61255941.Image47453927.getData()?has_content && cur_Fieldset61255941.Image47453927.getData() != "">
            <img class="d-block w-100" style="object-fit: cover; height: 100%;" alt="${cur_Fieldset61255941.Image47453927.getAttribute("alt")}" data-fileentryid="${cur_Fieldset61255941.Image47453927.getAttribute("fileEntryId")}" src="${cur_Fieldset61255941.Image47453927.getData()}" />
          </#if>
